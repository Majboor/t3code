// This file mostly exists because we want dev mode to say "LogicPacks (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "LogicPacks (Dev)" : "LogicPacks (Alpha)";
